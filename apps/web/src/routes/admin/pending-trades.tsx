...
export function PendingTradesPage() {
  ...
  return (
    <div className="space-y-6">
      <h1 className="text-2xl font-bold text-gray-900 dark:text-gray-100">Pending Trade Approvals</h1>
      ...
      {isLoading ? (
        ...
        <p className="text-gray-500 dark:text-gray-400 text-sm">No trades awaiting approval.</p>
      )}
    </div>
  );
}
